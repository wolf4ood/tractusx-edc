...
/**
 * {@code DataFlowResumeMessage} as defined by the Data Plane Signaling protocol. Serialized as plain JSON.
 */
@JsonDeserialize(builder = DataFlowResumeMessage.Builder.class)
@JsonIgnoreProperties(ignoreUnknown = true)
public final class DataFlowResumeMessage {

    private String messageId;
    private DspDataAddress dataAddress;

    private DataFlowResumeMessage() {
    }
