...
/**
 * {@code DataFlowPrepareMessage} as defined by the Data Plane Signaling protocol, sent by a control plane to provision
 * (prepare) a data flow on the provider data plane. Serialized as plain JSON.
 */
